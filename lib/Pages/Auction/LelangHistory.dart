...
class _HistoryLelangState extends State<HistoryLelang> {
  ...
  void initState() {
    ...
    super.initState();
    Api.historyLelang('1').then((value){
      setState(() {
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      onPressed: () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ViewAll(page:1,title: 'History Lelang'))
                      ),
                      child: Container(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => 
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => DetailLelang(id_lelang: int.parse(historyLelang[i].idLelang!),))
                        ),
                      child: Card(
                            ...
                            child: Column(
                              children: [
                                SizedBox(
                                  ...
                                  height: 100,
                                  child: Image.network(
                                    "$imageBarangPath${historyLelang[i].barang!.imageBarang!}",
                                    width: 100,
                                    height: 100,
                                    fit: BoxFit.cover,
                                ...
                                Text(
                                  "Rp.${widget.currencyFormatter.format(int.parse(historyLelang[i].barang!.hargaAkhir! == "" ? historyLelang[i].barang!.hargaAwal! : historyLelang[i].barang!.hargaAkhir!))}",
                                  style: TextStyle(
